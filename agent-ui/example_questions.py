...
EXAMPLE_QUESTIONS: tuple[ExampleQuestion, ...] = (
    ...
    ExampleQuestion(
        ...
        question=(
            "買付者は当社、株券等の発行者は当社とは別の上場会社（対象会社）です。"
            "対象会社の株券等の所有者が少数である場合の適用除外について、所有割合の計算で"
            "当社分と合算する「特別関係者」とはどのような者ですか。適用除外の具体的条件と"
            "「特別関係者」の定義を、根拠条文とともに説明してください。"
        ),
        expected="金融商品取引法＋施行令＋公開買付府令",
        required_evidence=(
            _articles(
    ...
    ExampleQuestion(
        ...
        answer_points=(
            ...
            _point("新聞公告に使用する日刊新聞紙の条件", ("二以上", "日刊新聞紙"), ("全国", "一以上")),
