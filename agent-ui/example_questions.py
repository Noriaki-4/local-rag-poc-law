...
EXAMPLE_QUESTIONS: tuple[ExampleQuestion, ...] = (
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "記載しなければならない事項と添付書類も含めて説明してください。"
        ),
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "取得者に課される転売制限の内容や勧誘時に必要な告知も含めて説明してください。"
        ),
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "主な適用除外、公開買付けが必要な場合の手続を説明してください。"
        ),
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "対象にできる人の範囲、譲渡制限をいつまで課す必要があるかも含めて説明してください。"
        ),
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "選択した方法ごとに守る必要がある条件を区別して説明してください。"
        ),
        expected="金融商品取引法＋施行令＋公開買付府令",
        required_evidence=(
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "法令上省略できない部分を区別し、修正が必要な点を説明してください。"
        ),
        expected="金融商品取引法＋施行令＋公開買付府令",
        required_evidence=(
            _articles("公開買付開始公告（金融商品取引法27条の3）", "law-323AC0000000025-article-27_3"),
    ...
    ExampleQuestion(
        ...
        title="公開買付開始公告の改正影響",
        question=(
            "金融商品取引法第27条の3のうち、公開買付開始公告の方法や公告事項に関する部分が改正された場合、"
            "関連して確認すべき政令・内閣府令の条文はどれですか。それぞれが公告方法と公告事項のどちらを"
            "定めているかも教えてください。"
        ),
        expected="金融商品取引法＋施行令＋公開買付府令",
        required_evidence=(
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "負担範囲をどう判断するのか、敷金から差し引けるのかも含めて教えてください。"
        ),
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "まだ承認されていない医薬品を広告できるかも含めて教えてください。"
        ),
        expected="薬機法＋適正広告基準",
        required_evidence=(
    ...
    ExampleQuestion(
        ...
        question=(
            ...
            "必要ですか。社内で整えておくべき勧誘の手続や管理体制も含めて教えてください。"
        ),
