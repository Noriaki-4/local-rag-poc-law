...
3. 残りの未確認Hypothesisを直接検証できる候補を探します。
4. まだ選んでいない法的機能の候補がある間は、同じ法的機能を重ねません。
5. `remaining_fetch_capacity`件以内で選びます。
6. 選択理由にはAssessmentで確定した主な法的機能と要約を反映し、全体の選択方針を自分の言葉で短く書きます。
